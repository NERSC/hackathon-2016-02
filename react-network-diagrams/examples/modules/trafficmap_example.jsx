...
export default React.createClass({
    ...
    handleSelectionChanged(selectionType, selection) {
        const message = `For ${selection}, Timestamp = ${timestamp}`;
            ...
            <div>
                <div className="row">
                    <div className="col-md-12">
                        <h3>BES Nodes and Logical Connections</h3>
                    </div>
                </div>
                ...
                <div className="row">
                    <div className="col-md-12">
                        <TrafficMap
                            bounds={{x1: -5, y1: 5, x2: 360, y2: 240}}
                            topology={topo}
                            traffic={traffic}
                ...
                <hr />
		This is where we want to print info about specific selections.
            </div>
        );
    }
});
